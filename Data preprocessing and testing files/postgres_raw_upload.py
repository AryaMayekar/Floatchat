...
def main():
    ...
    BASE_PATHS = [
        r"Data preprocessing and testing files\Data\BCG floats\raw_supabase_upload_csvs",
        r"Data preprocessing and testing files\Data\Non-BCG floats\raw_supabase_upload_csvs"
    ]
