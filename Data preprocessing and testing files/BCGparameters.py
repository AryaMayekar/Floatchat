...
def save_to_csv(df, year, month):
    ...
    base_dir = os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "unique floats")
...
def download_sprof_files():
    ...
    csv_path = os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "unique floats", "BCG floats Platform number list.csv")
    ...
    output_dir = os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "netcdf files")
...
def ensure_directories_exist():
    ...
    directories = [
        os.path.join("Data preprocessing and testing files", "Data"),
        os.path.join("Data preprocessing and testing files", "Data", "BCG floats"),
        os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "unique floats"),
        os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "netcdf files"),
        os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "raw csv"),
        os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "final csv files")
    ]
...
def convert_netcdf_to_csv():
    ...
    source_dir = os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "netcdf files")
    dest_dir = os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "raw csv")
...
def process_raw_csv_to_final():
    ...
    # Source and destination directories
    source_dir = os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "raw csv")
    dest_dir = os.path.join("Data preprocessing and testing files", "Data", "BCG floats", "final csv files")
