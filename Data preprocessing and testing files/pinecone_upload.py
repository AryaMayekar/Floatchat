...
BCG_CSV_PATH = Path("Data preprocessing and testing files/Data/BCG floats/final csv files")
NON_BCG_BASE_PATH = Path("Data preprocessing and testing files/Data/Non-BCG floats/final_csv")
